<template>
    <Transition name="modal">
        <div v-if="isModalOpen" class="fixed inset-0 z-9999 flex items-center justify-center bg-black/60 p-4" @click.self="close">
            <div class="flex flex-col gap-2 bg-modal-background rounded-2xl p-5 max-w-md w-full border border-white/10 shadow-xl transition-all duration-150 transform">
