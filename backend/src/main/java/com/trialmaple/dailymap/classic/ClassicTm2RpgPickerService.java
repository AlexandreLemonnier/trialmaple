...
@Service
public class ClassicTm2RpgPickerService extends AbstractClassicPickerService {

    public ClassicTm2RpgPickerService(TmMapRepository tmMapRepository, DailyMapRepository dailyMapRepository) {
