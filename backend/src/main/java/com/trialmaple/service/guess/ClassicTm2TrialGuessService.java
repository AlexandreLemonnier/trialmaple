...
@Service
public class ClassicTm2TrialGuessService extends AbstractGuessService {

    public ClassicTm2TrialGuessService(TmMapRepository tmMapRepository, ScoreRepository scoreRepository) {
