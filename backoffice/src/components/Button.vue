<template>
    <button type="button"
            class="flex items-center justify-center gap-1.5 lg:gap-2 w-fit text-sm lg:text-base border border-app-border py-1 px-3 bg-button rounded-lg cursor-pointer"
            :disabled>
